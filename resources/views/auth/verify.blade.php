		...
		<div class="flex flex-wrap justify-center">
			<div class="w-full max-w-sm">
				...
				<div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
					<div class="px-6 py-3 mb-0 font-semibold text-gray-700 bg-gray-200">{{ __('Verify Your Email Address') }}</div>
					<div class="flex flex-wrap w-full p-6">
						<p class="leading-normal">{{ __('Before proceeding, please check your email for a verification link.') }}</p>
