		...
		<div class="flex flex-wrap justify-center">
			<div class="w-full max-w-sm">
				<div class="flex flex-col break-words border border-2 rounded shadow-md bg-card">
					<div class="px-6 py-3 mb-0 font-semibold text-gray-700 bg-header ">{{ __('Register') }}</div>
					<form class="w-full p-6" method="POST" action="{{ route('register') }}">
							@csrf
							<div class="flex flex-wrap mb-6">
								<label for="name" class="block mb-2 text-sm font-bold text-gray-700">{{ __('Name') }}:</label>
							...
							<div class="flex flex-wrap mb-6">
								<label for="email" class="block mb-2 text-sm font-bold text-gray-700">{{ __('E-Mail Address') }}:</label>
							...
							<div class="flex flex-wrap mb-6">
								<label for="password-confirm" class="block mb-2 text-sm font-bold text-gray-700">{{ __('Confirm Password') }}:</label>
							...
							<div class="flex flex-wrap">
								...
								<p class="w-full mt-8 -mb-4 text-xs text-center text-gray-700">{{ __('Already have an account?') }}
									<a class="text-blue-500 no-underline hover:text-blue-700" href="{{ route('login') }}">{{ __('Login') }}</a>
								</p>
							</div>
					</form>
				</div>
